...
class Ui_DNSDialog(object):
    def setupUi(self, DNSDialog):
        ...
        self.labelDSDesc.setOpenExternalLinks(True)
        ...
        self.labelTLSDesc.setOpenExternalLinks(True)
        ...
        self.labelIMPORTDesc.setOpenExternalLinks(True)
    ...
    def retranslateUi(self, DNSDialog):
        ...
        self.labelDSDesc.setText(_translate("DNSDialog", "DNSSEC fingerprints for securing the domain when used with DNS via NS. Format roughly mirrors RFC3658.  <a href=\"https://www.namecoin.org/docs/name-owners/dnssec/\">See the DNSSEC documentation for more details.</a>"))
        ...
        self.labelTLSDesc.setText(_translate("DNSDialog", "A TLS record authenticates TLS servers without a public certificate authority.  TLS records are valid for <code>example.bit</code> and all subdomains.  You can generate a TLS record via:<br><code>generate_nmc_cert -use-ca -use-aia -host example.bit</code><br><a href=\"https://www.namecoin.org/docs/name-owners/tls/\">See the TLS documentation for more details.</a>"))
        self.label_24.setText(_translate("DNSDialog", "DANE-TA Public Key (Base64)"))
...
""))
        ...
        self.labelIMPORTDesc.setText(_translate("DNSDialog", "Imports specified entries from another Namecoin name and merges with the current one. Optionally, import entries and associate them with a designated subdomain.  <a href=\"https://www.namecoin.org/docs/name-owners/delegated-alteration/\">See the Delegated Alteration documentation for more details.</a>"))
